 ...
 */
final class Version20250224031005 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX fk_692907eeddc7141 ON expedition');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX FK_692907EEDDC7141 ON expedition (aventurier_id)');
        $this->addSql('ALTER TABLE expedition ADD CONSTRAINT FK_692907EEDDC7141 FOREIGN KEY (aventurier_id) REFERENCES aventurier (id)');
