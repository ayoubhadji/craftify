 ...
 */
final class Version20250224024427 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE expedition DROP FOREIGN KEY FK_692907EEDDC7141');
        $this->addSql('ALTER TABLE expedition CHANGE titre titre VARCHAR(255) DEFAULT NULL, CHANGE objectif objectif TEXT DEFAULT NULL, CHANGE date_debut date_debut DATETIME DEFAULT NULL, CHANGE date_fin date_fin DATETIME DEFAULT NULL, CHANGE statut statut VARCHAR(50) DEFAULT NULL, CHANGE distance_parcourue distance_parcourue NUMERIC(10, 2) DEFAULT NULL, CHANGE rapport rapport TEXT DEFAULT NULL, CHANGE aventurier_id aventurier_id INT UNSIGNED DEFAULT NULL');
        $this->addSql('ALTER TABLE expedition ADD CONSTRAINT expedition_ibfk_1 FOREIGN KEY (aventurier_id) REFERENCES aventurier (id) ON DELETE CASCADE');
